    ...
    (0, _mocha.describe)('Acceptance: Editor', function () {
        ...
        (0, _mocha.describe)('when logged in', function () {
            ...
            (0, _mocha.it)('renders the editor correctly, PSM Publish Date and Save Button', function () {
                ...
                andThen(function () {
                    (0, _chai.expect)(find('.btn.btn-sm.js-publish-button').hasClass('btn-red'), 'no red button expected').to.be['false'];
                    (0, _chai.expect)(find('.btn.btn-sm.js-publish-button').text().trim(), 'text in save button').to.equal('Save Draft');
                ...
                andThen(function () {
                    ...
                    (0, _chai.expect)(find('.btn.btn-sm.js-publish-button').hasClass('btn-red'), 'red button to change from draft to published').to.be['true'];
                    (0, _chai.expect)(find('.btn.btn-sm.js-publish-button').text().trim(), 'text in save button after click on \'publish now\'').to.equal('Publish Now');
                });
                ...
                andThen(function () {
                    (0, _chai.expect)(find('.btn.btn-sm.js-publish-button').text().trim(), 'text in save button after publishing').to.equal('Update Post');
                ...
                andThen(function () {
                    ...
                    (0, _chai.expect)(find('.btn.btn-sm.js-publish-button').hasClass('btn-red'), 'red button to change from published to draft').to.be['true'];
                    (0, _chai.expect)(find('.btn.btn-sm.js-publish-button').text().trim(), 'text in save button for post to unpublish').to.equal('Unpublish');
                });
                ...
                andThen(function () {
                    (0, _chai.expect)(find('.btn.btn-sm.js-publish-button').text().trim(), 'text in save button for draft').to.equal('Save Draft');
                    (0, _chai.expect)(find('.post-save-draft').hasClass('active'), 'highlights the default active button state for a draft').to.be['true'];
                    (0, _chai.expect)(find('.btn.btn-sm.js-publish-button').hasClass('btn-red'), 'no red button expected').to.be['false'];
                });
                ...
                andThen(function () {
                    ...
                    (0, _chai.expect)(find('.btn.btn-sm.js-publish-button').hasClass('btn-red'), 'red button to change from published to draft').to.be['true'];
                    (0, _chai.expect)(find('.btn.btn-sm.js-publish-button').text().trim(), 'text in save button for post to schedule').to.equal('Schedule Post');
                });
                ...
                andThen(function () {
                    ...
                    (0, _chai.expect)(find('.btn.btn-sm.js-publish-button').text().trim(), 'text in save button for scheduled post').to.equal('Update Post');
                ...
                andThen(function () {
                    (0, _chai.expect)(find('.btn.btn-sm.js-publish-button').text().trim(), 'text in save button to unscheduled post').to.equal('Unschedule');
                    ...
                    (0, _chai.expect)(find('.btn.btn-sm.js-publish-button').hasClass('btn-red'), 'red button expected due to status change').to.be['true'];
                });
                ...
                andThen(function () {
                    (0, _chai.expect)(find('.btn.btn-sm.js-publish-button').text().trim(), 'text in save button for a draft').to.equal('Save Draft');
                    ...
                    (0, _chai.expect)(find('.btn.btn-sm.js-publish-button').hasClass('btn-red'), 'red button expected due to status change').to.be['false'];
            ...
            (0, _mocha.it)('only shows option to unschedule post 2 minutes before scheduled time', function () {
                ...
                andThen(function () {
                    ...
                    (0, _chai.expect)(find('.btn.btn-sm.js-publish-button').text().trim(), 'text in save button for scheduled post in status freeze mode').to.equal('Unschedule');
                    // expect countdown to show warning, that post will be published in x minutes
                    (0, _chai.expect)(find('.gh-notification.gh-notification-schedule').text().trim(), 'notification countdown').to.contain('Post will be published in');
                    // no dropdown menu
...
/* jshint expr:true */
/* eslint-disable camelcase */
define('ghost-admin/tests/acceptance/posts/post-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - acceptance/posts/post-test.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/acceptance/settings/general-test', ['exports', 'mocha', 'chai', 'jquery', 'ghost-admin/tests/helpers/start-app', 'ghost-admin/tests/helpers/destroy-app', 'ghost-admin/tests/helpers/ember-simple-auth', 'ember-cli-mirage', 'ghost-admin/mirage/config/themes'], function (exports, _mocha, _chai, _jquery, _ghostAdminTestsHelpersStartApp, _ghostAdminTestsHelpersDestroyApp, _ghostAdminTestsHelpersEmberSimpleAuth, _emberCliMirage, _ghostAdminMirageConfigThemes) {
...
/* jshint expr:true */
/* eslint-disable camelcase */
define('ghost-admin/tests/acceptance/settings/navigation-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - acceptance/settings/navigation-test.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
});
define('ghost-admin/tests/acceptance/settings/slack-test', ['exports', 'mocha', 'chai', 'ghost-admin/tests/helpers/start-app', 'ghost-admin/tests/helpers/destroy-app', 'ember-cli-mirage', 'ghost-admin/tests/helpers/ember-simple-auth'], function (exports, _mocha, _chai, _ghostAdminTestsHelpersStartApp, _ghostAdminTestsHelpersDestroyApp, _emberCliMirage, _ghostAdminTestsHelpersEmberSimpleAuth) {
    var _slicedToArray = (function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i['return']) _i['return'](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError('Invalid attempt to destructure non-iterable instance'); } }; })();
...
define('ghost-admin/tests/acceptance/signin-test', ['exports', 'mocha', 'chai', 'jquery', 'ghost-admin/tests/helpers/start-app', 'ghost-admin/tests/helpers/destroy-app', 'ghost-admin/tests/helpers/ember-simple-auth', 'ghost-admin/tests/helpers/configuration', 'ember-cli-mirage', 'ghost-admin/tests/helpers/oauth'], function (exports, _mocha, _chai, _jquery, _ghostAdminTestsHelpersStartApp, _ghostAdminTestsHelpersDestroyApp, _ghostAdminTestsHelpersEmberSimpleAuth, _ghostAdminTestsHelpersConfiguration, _emberCliMirage, _ghostAdminTestsHelpersOauth) {
    ...
    (0, _mocha.describe)('Acceptance: Signup', function () {
        ...
        (0, _mocha.describe)('using Ghost OAuth', function () {
            (0, _mocha.beforeEach)(function () {
                ...
                var user = server.create('user', { name: 'Test Invite Creator' });
        ...
        (0, _mocha.describe)('when logged in as admin', function () {
            ...
            (0, _mocha.it)('can manage invites', function () {
                ...
                andThen(function () {
                    ...
                    (0, _chai.expect)(find('.view-actions .btn-green').text().trim(), 'invite people button text').to.equal('Invite People');

                    // existing users are listed
                    (0, _chai.expect)(find('.user-list.active-users .user-list-item').length, 'initial number of active users').to.equal(1);

                    (0, _chai.expect)(find('.user-list.active-users .user-list-item:first-of-type .role-label').text().trim(), 'active user\'s role label').to.equal('Administrator');

                    // no invites are shown
                    (0, _chai.expect)(find('.user-list.invited-users .user-list-item').length, 'initial number of invited users').to.equal(0);
                });
                ...
                andThen(function () {
                    ...
                    (0, _chai.expect)(find('.invited-users .user-list-item').length, 'number of invites after first invite').to.equal(1);

                    (0, _chai.expect)(find('.invited-users span.name').first().text().trim(), 'displayed email of first invite').to.equal('invite1@example.com');

                    (0, _chai.expect)(find('.invited-users span.role-label').first().text().trim(), 'displayed role of first invite').to.equal('Author');

                    // number of users is unchanged
                    (0, _chai.expect)(find('.active-users .user-list-item').length, 'number of active users after first invite').to.equal(1);
                });
                ...
                andThen(function () {
                    ...
                    (0, _chai.expect)(find('.invited-users .user-list-item').length, 'number of invites after second invite').to.equal(2);

                    // invite has correct e-mail + role
                    (0, _chai.expect)(find('.invited-users span.name').last().text().trim(), 'displayed email of second invite').to.equal('invite2@example.com');

                    (0, _chai.expect)(find('.invited-users span.role-label').last().text().trim(), 'displayed role of second invite').to.equal('Editor');
                });
                ...
                andThen(function () {
                    ...
                    (0, _chai.expect)(find('.invited-users .user-list-item').length, 'number of invites after revoke').to.equal(1);
                    ...
                    (0, _chai.expect)(find('.invited-users span.name').text().trim(), 'displayed email of remaining invite').to.equal('invite1@example.com');
                });
                ...
                andThen(function () {
                    ...
                    (0, _chai.expect)(find('.invited-users span.name').last().text().trim(), 'last invite email in list').to.equal('invite3@example.com');
                });
                ...
                andThen(function () {
                    ...
                    (0, _chai.expect)(find('.invited-users span.name').first().text().trim(), 'first invite email in list').to.equal('invite1@example.com');
                });
                ...
                andThen(function () {
                    // number of invites decreases
                    (0, _chai.expect)(find('.invited-users .user-list-item').length, 'number of invites after resend/revoke').to.equal(1);
...
define('ghost-admin/tests/authenticators/oauth2-ghost.lint-test', ['exports'], function (exports) {
  ...
  describe('ESLint - authenticators/oauth2-ghost.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/components/gh-content-preview-content.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - components/gh-content-preview-content.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
});
define('ghost-admin/tests/components/gh-content-view-container.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - components/gh-content-view-container.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/controllers/post-settings-menu.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - controllers/post-settings-menu.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/controllers/settings/navigation.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - controllers/settings/navigation.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/helpers/ember-basic-dropdown', ['exports', 'ember', 'ember-runloop'], function (exports, _ember, _emberRunloop) {
...
define('ghost-admin/tests/helpers/ember-power-select', ['exports', 'jquery', 'ember-runloop', 'ember-test'], function (exports, _jquery, _emberRunloop, _emberTest) {
...
define('ghost-admin/tests/helpers/gh-format-markdown.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - helpers/gh-format-markdown.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/helpers/module-for-acceptance.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/initializers/trailing-history.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - initializers/trailing-history.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
        ...
        (0, _emberMocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-alert', [], ['message', ['subexpr', '@mut', [['get', 'message', ['loc', [null, [1, 19], [1, 26]]], 0, 0, 0, 0]], [], [], 0, 0]], ['loc', [null, [1, 0], [1, 28]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
...
define('ghost-admin/tests/integration/components/gh-alerts-test', ['exports', 'chai', 'ember-mocha', 'ember-service', 'ember-array/utils'], function (exports, _chai, _emberMocha, _emberService, _emberArrayUtils) {
        ...
        (0, _emberMocha.it)('renders', function () {
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['content', 'gh-alerts', ['loc', [null, [1, 0], [1, 13]]], 0, 0, 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('triggers "notify" action when message count changes', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-alerts', [], ['notify', ['subexpr', 'action', [['get', 'notify', ['loc', [null, [1, 27], [1, 33]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 19], [1, 34]]], 0, 0]], ['loc', [null, [1, 0], [1, 36]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('handles editor events', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-cm-editor', [['get', 'text', ['loc', [null, [1, 15], [1, 19]]], 0, 0, 0, 0]], ['class', 'gh-input', 'update', ['subexpr', 'action', [['subexpr', 'mut', [['get', 'text', ['loc', [null, [1, 57], [1, 61]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 52], [1, 62]]], 0, 0]], [], ['loc', [null, [1, 44], [1, 63]]], 0, 0]], ['loc', [null, [1, 0], [1, 65]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
...
define('ghost-admin/tests/integration/components/gh-feature-flag-test', ['exports', 'chai', 'ember-mocha', 'ember-service'], function (exports, _chai, _emberMocha, _emberService) {
        ...
        (0, _emberMocha.it)('renders properties correctly', function () {
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-feature-flag', ['testFlag'], [], ['loc', [null, [1, 0], [1, 30]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('renders', function () {
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['content', 'gh-file-uploader', ['loc', [null, [1, 0], [1, 20]]], 0, 0, 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('allows file input "accept" attribute to be changed', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-file-uploader', [], ['accept', 'application/zip'], ['loc', [null, [1, 0], [1, 45]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('renders form with supplied label text', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-file-uploader', [], ['labelText', ['subexpr', '@mut', [['get', 'labelText', ['loc', [null, [1, 29], [1, 38]]], 0, 0, 0, 0]], [], [], 0, 0]], ['loc', [null, [1, 0], [1, 40]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('generates request to supplied endpoint', function (done) {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-file-uploader', [], ['url', ['subexpr', '@mut', [['get', 'uploadUrl', ['loc', [null, [1, 23], [1, 32]]], 0, 0, 0, 0]], [], [], 0, 0]], ['loc', [null, [1, 0], [1, 34]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('fires uploadSuccess action on successful upload', function (done) {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-file-uploader', [], ['url', ['subexpr', '@mut', [['get', 'uploadUrl', ['loc', [null, [1, 23], [1, 32]]], 0, 0, 0, 0]], [], [], 0, 0], 'uploadSuccess', ['subexpr', 'action', [['get', 'uploadSuccess', ['loc', [null, [1, 55], [1, 68]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 47], [1, 69]]], 0, 0]], ['loc', [null, [1, 0], [1, 71]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('fires fileSelected action on file selection', function (done) {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-file-uploader', [], ['url', ['subexpr', '@mut', [['get', 'uploadUrl', ['loc', [null, [1, 23], [1, 32]]], 0, 0, 0, 0]], [], [], 0, 0], 'fileSelected', ['subexpr', 'action', [['get', 'fileSelected', ['loc', [null, [1, 54], [1, 66]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 46], [1, 67]]], 0, 0]], ['loc', [null, [1, 0], [1, 69]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('fires uploadStarted action on upload start', function (done) {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-file-uploader', [], ['url', ['subexpr', '@mut', [['get', 'uploadUrl', ['loc', [null, [1, 23], [1, 32]]], 0, 0, 0, 0]], [], [], 0, 0], 'uploadStarted', ['subexpr', 'action', [['get', 'uploadStarted', ['loc', [null, [1, 55], [1, 68]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 47], [1, 69]]], 0, 0]], ['loc', [null, [1, 0], [1, 71]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('fires uploadFinished action on successful upload', function (done) {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-file-uploader', [], ['url', ['subexpr', '@mut', [['get', 'uploadUrl', ['loc', [null, [1, 23], [1, 32]]], 0, 0, 0, 0]], [], [], 0, 0], 'uploadFinished', ['subexpr', 'action', [['get', 'uploadFinished', ['loc', [null, [1, 56], [1, 70]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 48], [1, 71]]], 0, 0]], ['loc', [null, [1, 0], [1, 73]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('displays upload progress', function (done) {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-file-uploader', [], ['url', ['subexpr', '@mut', [['get', 'uploadUrl', ['loc', [null, [1, 23], [1, 32]]], 0, 0, 0, 0]], [], [], 0, 0], 'uploadFinished', ['subexpr', 'action', [['get', 'done', ['loc', [null, [1, 56], [1, 60]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 48], [1, 61]]], 0, 0]], ['loc', [null, [1, 0], [1, 63]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('validates extension by default', function (done) {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-file-uploader', [], ['url', ['subexpr', '@mut', [['get', 'uploadUrl', ['loc', [null, [2, 20], [2, 29]]], 0, 0, 0, 0]], [], [], 0, 0], 'uploadSuccess', ['subexpr', 'action', [['get', 'uploadSuccess', ['loc', [null, [3, 38], [3, 51]]], 0, 0, 0, 0]], [], ['loc', [null, [3, 30], [3, 52]]], 0, 0], 'uploadFailed', ['subexpr', 'action', [['get', 'uploadFailed', ['loc', [null, [4, 37], [4, 49]]], 0, 0, 0, 0]], [], ['loc', [null, [4, 29], [4, 50]]], 0, 0]], ['loc', [null, [1, 0], [4, 52]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('uploads if validate action supplied and returns true', function (done) {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-file-uploader', [], ['url', ['subexpr', '@mut', [['get', 'uploadUrl', ['loc', [null, [2, 20], [2, 29]]], 0, 0, 0, 0]], [], [], 0, 0], 'uploadSuccess', ['subexpr', 'action', [['get', 'uploadSuccess', ['loc', [null, [3, 38], [3, 51]]], 0, 0, 0, 0]], [], ['loc', [null, [3, 30], [3, 52]]], 0, 0], 'validate', ['subexpr', 'action', [['get', 'validate', ['loc', [null, [4, 33], [4, 41]]], 0, 0, 0, 0]], [], ['loc', [null, [4, 25], [4, 42]]], 0, 0]], ['loc', [null, [1, 0], [4, 44]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('skips upload and displays error if validate action supplied and doesn\'t return true', function (done) {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-file-uploader', [], ['url', ['subexpr', '@mut', [['get', 'uploadUrl', ['loc', [null, [2, 20], [2, 29]]], 0, 0, 0, 0]], [], [], 0, 0], 'uploadSuccess', ['subexpr', 'action', [['get', 'uploadSuccess', ['loc', [null, [3, 38], [3, 51]]], 0, 0, 0, 0]], [], ['loc', [null, [3, 30], [3, 52]]], 0, 0], 'uploadFailed', ['subexpr', 'action', [['get', 'uploadFailed', ['loc', [null, [4, 37], [4, 49]]], 0, 0, 0, 0]], [], ['loc', [null, [4, 29], [4, 50]]], 0, 0], 'validate', ['subexpr', 'action', [['get', 'validate', ['loc', [null, [5, 33], [5, 41]]], 0, 0, 0, 0]], [], ['loc', [null, [5, 25], [5, 42]]], 0, 0]], ['loc', [null, [1, 0], [5, 44]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
    ...
    (0, _emberMocha.describeComponent)('gh-image-upload', 'Integration: Component: gh-image-uploader', {
        ...
        (0, _emberMocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-image-uploader', [], ['image', ['subexpr', '@mut', [['get', 'image', ['loc', [null, [1, 26], [1, 31]]], 0, 0, 0, 0]], [], [], 0, 0]], ['loc', [null, [1, 0], [1, 33]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('triggers formChanged action when switching between forms', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-image-uploader', [], ['image', ['subexpr', '@mut', [['get', 'image', ['loc', [null, [1, 26], [1, 31]]], 0, 0, 0, 0]], [], [], 0, 0], 'formChanged', ['subexpr', 'action', [['get', 'formChanged', ['loc', [null, [1, 52], [1, 63]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 44], [1, 64]]], 0, 0]], ['loc', [null, [1, 0], [1, 66]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
            ...
            (0, _emberMocha.it)('renders form with supplied alt text', function () {
                this.render(Ember.HTMLBars.template((function () {
                    return {
                        ...
                        statements: [['inline', 'gh-image-uploader', [], ['image', ['subexpr', '@mut', [['get', 'image', ['loc', [null, [1, 26], [1, 31]]], 0, 0, 0, 0]], [], [], 0, 0], 'altText', 'text test'], ['loc', [null, [1, 0], [1, 53]]], 0, 0]],
                        locals: [],
                        templates: []
                    };
                })()));
            ...
            (0, _emberMocha.it)('renders form with supplied text', function () {
                this.render(Ember.HTMLBars.template((function () {
                    return {
                        ...
                        statements: [['inline', 'gh-image-uploader', [], ['image', ['subexpr', '@mut', [['get', 'image', ['loc', [null, [1, 26], [1, 31]]], 0, 0, 0, 0]], [], [], 0, 0], 'text', 'text test'], ['loc', [null, [1, 0], [1, 50]]], 0, 0]],
                        locals: [],
                        templates: []
                    };
                })()));
            ...
            (0, _emberMocha.it)('generates request to correct endpoint', function (done) {
                ...
                this.render(Ember.HTMLBars.template((function () {
                    return {
                        ...
                        statements: [['inline', 'gh-image-uploader', [], ['image', ['subexpr', '@mut', [['get', 'image', ['loc', [null, [1, 26], [1, 31]]], 0, 0, 0, 0]], [], [], 0, 0], 'update', ['subexpr', 'action', [['get', 'update', ['loc', [null, [1, 47], [1, 53]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 39], [1, 54]]], 0, 0]], ['loc', [null, [1, 0], [1, 56]]], 0, 0]],
                        locals: [],
                        templates: []
                    };
                })()));
            ...
            (0, _emberMocha.it)('fires fileSelected action on file selection', function (done) {
                ...
                this.render(Ember.HTMLBars.template((function () {
                    return {
                        ...
                        statements: [['inline', 'gh-image-uploader', [], ['url', ['subexpr', '@mut', [['get', 'image', ['loc', [null, [1, 24], [1, 29]]], 0, 0, 0, 0]], [], [], 0, 0], 'fileSelected', ['subexpr', 'action', [['get', 'fileSelected', ['loc', [null, [1, 51], [1, 63]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 43], [1, 64]]], 0, 0], 'update', ['subexpr', 'action', [['get', 'update', ['loc', [null, [1, 80], [1, 86]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 72], [1, 87]]], 0, 0]], ['loc', [null, [1, 0], [1, 89]]], 0, 0]],
                        locals: [],
                        templates: []
                    };
                })()));
            ...
            (0, _emberMocha.it)('fires uploadStarted action on upload start', function (done) {
                ...
                this.render(Ember.HTMLBars.template((function () {
                    return {
                        ...
                        statements: [['inline', 'gh-image-uploader', [], ['image', ['subexpr', '@mut', [['get', 'image', ['loc', [null, [1, 26], [1, 31]]], 0, 0, 0, 0]], [], [], 0, 0], 'uploadStarted', ['subexpr', 'action', [['get', 'uploadStarted', ['loc', [null, [1, 54], [1, 67]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 46], [1, 68]]], 0, 0], 'update', ['subexpr', 'action', [['get', 'update', ['loc', [null, [1, 84], [1, 90]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 76], [1, 91]]], 0, 0]], ['loc', [null, [1, 0], [1, 93]]], 0, 0]],
                        locals: [],
                        templates: []
                    };
                })()));
            ...
            (0, _emberMocha.it)('fires uploadFinished action on successful upload', function (done) {
                ...
                this.render(Ember.HTMLBars.template((function () {
                    return {
                        ...
                        statements: [['inline', 'gh-image-uploader', [], ['image', ['subexpr', '@mut', [['get', 'image', ['loc', [null, [1, 26], [1, 31]]], 0, 0, 0, 0]], [], [], 0, 0], 'uploadFinished', ['subexpr', 'action', [['get', 'uploadFinished', ['loc', [null, [1, 55], [1, 69]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 47], [1, 70]]], 0, 0], 'update', ['subexpr', 'action', [['get', 'update', ['loc', [null, [1, 86], [1, 92]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 78], [1, 93]]], 0, 0]], ['loc', [null, [1, 0], [1, 95]]], 0, 0]],
                        locals: [],
                        templates: []
                    };
                })()));
            ...
            (0, _emberMocha.it)('displays upload progress', function (done) {
                ...
                this.render(Ember.HTMLBars.template((function () {
                    return {
                        ...
                        statements: [['inline', 'gh-image-uploader', [], ['image', ['subexpr', '@mut', [['get', 'image', ['loc', [null, [1, 26], [1, 31]]], 0, 0, 0, 0]], [], [], 0, 0], 'uploadFinished', ['subexpr', 'action', [['get', 'done', ['loc', [null, [1, 55], [1, 59]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 47], [1, 60]]], 0, 0], 'update', ['subexpr', 'action', [['get', 'update', ['loc', [null, [1, 76], [1, 82]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 68], [1, 83]]], 0, 0]], ['loc', [null, [1, 0], [1, 85]]], 0, 0]],
                        locals: [],
                        templates: []
                    };
                })()));
            ...
            (0, _emberMocha.it)('triggers file upload on file drop', function (done) {
                ...
                this.render(Ember.HTMLBars.template((function () {
                    return {
                        ...
                        statements: [['inline', 'gh-image-uploader', [], ['uploadSuccess', ['subexpr', 'action', [['get', 'uploadSuccess', ['loc', [null, [1, 42], [1, 55]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 34], [1, 56]]], 0, 0]], ['loc', [null, [1, 0], [1, 58]]], 0, 0]],
                        locals: [],
                        templates: []
                    };
                })()));
            ...
            (0, _emberMocha.it)('validates extension by default', function (done) {
                ...
                this.render(Ember.HTMLBars.template((function () {
                    return {
                        ...
                        statements: [['inline', 'gh-image-uploader', [], ['uploadSuccess', ['subexpr', 'action', [['get', 'uploadSuccess', ['loc', [null, [2, 42], [2, 55]]], 0, 0, 0, 0]], [], ['loc', [null, [2, 34], [2, 56]]], 0, 0], 'uploadFailed', ['subexpr', 'action', [['get', 'uploadFailed', ['loc', [null, [3, 41], [3, 53]]], 0, 0, 0, 0]], [], ['loc', [null, [3, 33], [3, 54]]], 0, 0]], ['loc', [null, [1, 0], [3, 56]]], 0, 0]],
                        locals: [],
                        templates: []
                    };
                })()));
            ...
            (0, _emberMocha.it)('uploads if validate action supplied and returns true', function (done) {
                ...
                this.render(Ember.HTMLBars.template((function () {
                    return {
                        ...
                        statements: [['inline', 'gh-image-uploader', [], ['uploadSuccess', ['subexpr', 'action', [['get', 'uploadSuccess', ['loc', [null, [2, 42], [2, 55]]], 0, 0, 0, 0]], [], ['loc', [null, [2, 34], [2, 56]]], 0, 0], 'validate', ['subexpr', 'action', [['get', 'validate', ['loc', [null, [3, 37], [3, 45]]], 0, 0, 0, 0]], [], ['loc', [null, [3, 29], [3, 46]]], 0, 0]], ['loc', [null, [1, 0], [3, 48]]], 0, 0]],
                        locals: [],
                        templates: []
                    };
                })()));
            ...
            (0, _emberMocha.it)('skips upload and displays error if validate action supplied and doesn\'t return true', function (done) {
                ...
                this.render(Ember.HTMLBars.template((function () {
                    return {
                        ...
                        statements: [['inline', 'gh-image-uploader', [], ['uploadSuccess', ['subexpr', 'action', [['get', 'uploadSuccess', ['loc', [null, [2, 42], [2, 55]]], 0, 0, 0, 0]], [], ['loc', [null, [2, 34], [2, 56]]], 0, 0], 'uploadFailed', ['subexpr', 'action', [['get', 'uploadFailed', ['loc', [null, [3, 41], [3, 53]]], 0, 0, 0, 0]], [], ['loc', [null, [3, 33], [3, 54]]], 0, 0], 'validate', ['subexpr', 'action', [['get', 'validate', ['loc', [null, [4, 37], [4, 45]]], 0, 0, 0, 0]], [], ['loc', [null, [4, 29], [4, 46]]], 0, 0]], ['loc', [null, [1, 0], [4, 48]]], 0, 0]],
                        locals: [],
                        templates: []
                    };
                })()));
        ...
        describe('URL input form', function () {
            ...
            (0, _emberMocha.it)('can render without a save button', function () {
                this.render(Ember.HTMLBars.template((function () {
                    return {
                        ...
                        statements: [['inline', 'gh-image-uploader', [], ['image', ['subexpr', '@mut', [['get', 'image', ['loc', [null, [1, 26], [1, 31]]], 0, 0, 0, 0]], [], [], 0, 0], 'saveButton', false, 'text', 'text test'], ['loc', [null, [1, 0], [1, 67]]], 0, 0]],
                        locals: [],
                        templates: []
                    };
                })()));
            ...
            (0, _emberMocha.it)('fires onInput action when typing URL', function () {
                ...
                this.render(Ember.HTMLBars.template((function () {
                    return {
                        ...
                        statements: [['inline', 'gh-image-uploader', [], ['image', ['subexpr', '@mut', [['get', 'image', ['loc', [null, [1, 26], [1, 31]]], 0, 0, 0, 0]], [], [], 0, 0], 'onInput', ['subexpr', 'action', [['get', 'onInput', ['loc', [null, [1, 48], [1, 55]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 40], [1, 56]]], 0, 0]], ['loc', [null, [1, 0], [1, 58]]], 0, 0]],
                        locals: [],
                        templates: []
                    };
                })()));
            ...
            (0, _emberMocha.it)('saves on enter key', function () {
                ...
                // eslint-disable-next-line new-cap
                _jquery['default'].Event('keyup', { keyCode: keyCodes.enter, which: keyCodes.enter }));
        ...
        (0, _emberMocha.it)('renders image if provided', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-image-uploader-with-preview', [], ['image', ['subexpr', '@mut', [['get', 'image', ['loc', [null, [1, 39], [1, 44]]], 0, 0, 0, 0]], [], [], 0, 0]], ['loc', [null, [1, 0], [1, 46]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('triggers remove action when delete icon is clicked', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-image-uploader-with-preview', [], ['image', ['subexpr', '@mut', [['get', 'image', ['loc', [null, [1, 39], [1, 44]]], 0, 0, 0, 0]], [], [], 0, 0], 'remove', ['subexpr', 'action', [['get', 'remove', ['loc', [null, [1, 60], [1, 66]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 52], [1, 67]]], 0, 0]], ['loc', [null, [1, 0], [1, 69]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
                    ...
                    var child0 = (function () {
                        var child0 = (function () {
                            return {
                                ...
                                statements: [['inline', 'gh-navitem', [], ['navItem', ['subexpr', '@mut', [['get', 'navItem', ['loc', [null, [5, 49], [5, 56]]], 0, 0, 0, 0]], [], [], 0, 0], 'baseUrl', ['subexpr', '@mut', [['get', 'blogUrl', ['loc', [null, [5, 65], [5, 72]]], 0, 0, 0, 0]], [], [], 0, 0], 'addItem', 'addItem', 'deleteItem', 'deleteItem', 'updateUrl', 'updateUrl'], ['loc', [null, [5, 28], [5, 138]]], 0, 0]],
                                locals: ['navItem'],
                                templates: []
                            };
                        })();
                        ...
                        return {
                            ...
                            statements: [['block', 'each', [['get', 'navigationItems', ['loc', [null, [4, 32], [4, 47]]], 0, 0, 0, 0]], [], 0, null, ['loc', [null, [4, 24], [6, 33]]]]],
                            locals: [],
                            templates: [child0]
                        };
                    })();
...
define('ghost-admin/tests/integration/components/gh-navitem-test', ['exports', 'chai', 'ember-mocha', 'ghost-admin/models/navigation-item'], function (exports, _chai, _emberMocha, _ghostAdminModelsNavigationItem) {
        ...
        (0, _emberMocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-navitem', [], ['navItem', ['subexpr', '@mut', [['get', 'navItem', ['loc', [null, [1, 21], [1, 28]]], 0, 0, 0, 0]], [], [], 0, 0], 'baseUrl', ['subexpr', '@mut', [['get', 'baseUrl', ['loc', [null, [1, 37], [1, 44]]], 0, 0, 0, 0]], [], [], 0, 0]], ['loc', [null, [1, 0], [1, 46]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('triggers delete action', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-navitem', [], ['navItem', ['subexpr', '@mut', [['get', 'navItem', ['loc', [null, [1, 21], [1, 28]]], 0, 0, 0, 0]], [], [], 0, 0], 'baseUrl', ['subexpr', '@mut', [['get', 'baseUrl', ['loc', [null, [1, 37], [1, 44]]], 0, 0, 0, 0]], [], [], 0, 0], 'deleteItem', 'deleteItem'], ['loc', [null, [1, 0], [1, 70]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('triggers add action', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-navitem', [], ['navItem', ['subexpr', '@mut', [['get', 'navItem', ['loc', [null, [1, 21], [1, 28]]], 0, 0, 0, 0]], [], [], 0, 0], 'baseUrl', ['subexpr', '@mut', [['get', 'baseUrl', ['loc', [null, [1, 37], [1, 44]]], 0, 0, 0, 0]], [], [], 0, 0], 'addItem', 'add'], ['loc', [null, [1, 0], [1, 60]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('triggers update action', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-navitem', [], ['navItem', ['subexpr', '@mut', [['get', 'navItem', ['loc', [null, [1, 21], [1, 28]]], 0, 0, 0, 0]], [], [], 0, 0], 'baseUrl', ['subexpr', '@mut', [['get', 'baseUrl', ['loc', [null, [1, 37], [1, 44]]], 0, 0, 0, 0]], [], [], 0, 0], 'updateUrl', 'update'], ['loc', [null, [1, 0], [1, 65]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('renders correctly with blank url', function () {
            this.render(_ember['default'].HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-navitem-url-input', [], ['baseUrl', ['subexpr', '@mut', [['get', 'baseUrl', ['loc', [null, [2, 47], [2, 54]]], 0, 0, 0, 0]], [], [], 0, 0], 'url', ['subexpr', '@mut', [['get', 'url', ['loc', [null, [2, 59], [2, 62]]], 0, 0, 0, 0]], [], [], 0, 0], 'isNew', ['subexpr', '@mut', [['get', 'isNew', ['loc', [null, [2, 69], [2, 74]]], 0, 0, 0, 0]], [], [], 0, 0], 'change', 'updateUrl', 'clearErrors', ['subexpr', 'action', ['clearErrors'], [], ['loc', [null, [2, 106], [2, 128]]], 0, 0]], ['loc', [null, [2, 16], [2, 130]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
            ...
            (0, _emberMocha.it)('handles URLs relative to base url', function () {
                ...
                this.render(_ember['default'].HTMLBars.template((function () {
                    return {
                        ...
                        statements: [['inline', 'gh-navitem-url-input', [], ['baseUrl', ['subexpr', '@mut', [['get', 'baseUrl', ['loc', [null, [2, 51], [2, 58]]], 0, 0, 0, 0]], [], [], 0, 0], 'url', ['subexpr', '@mut', [['get', 'url', ['loc', [null, [2, 63], [2, 66]]], 0, 0, 0, 0]], [], [], 0, 0], 'isNew', ['subexpr', '@mut', [['get', 'isNew', ['loc', [null, [2, 73], [2, 78]]], 0, 0, 0, 0]], [], [], 0, 0], 'change', 'updateUrl', 'clearErrors', ['subexpr', 'action', ['clearErrors'], [], ['loc', [null, [2, 110], [2, 132]]], 0, 0]], ['loc', [null, [2, 20], [2, 134]]], 0, 0]],
                        locals: [],
                        templates: []
                    };
                })()));
        ...
        (0, _emberMocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-notification', [], ['message', ['subexpr', '@mut', [['get', 'message', ['loc', [null, [1, 26], [1, 33]]], 0, 0, 0, 0]], [], [], 0, 0]], ['loc', [null, [1, 0], [1, 35]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
...
define('ghost-admin/tests/integration/components/gh-notifications-test', ['exports', 'chai', 'ember-mocha', 'ember-service', 'ember-array/utils'], function (exports, _chai, _emberMocha, _emberService, _emberArrayUtils) {
        ...
        (0, _emberMocha.it)('renders', function () {
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['content', 'gh-notifications', ['loc', [null, [1, 0], [1, 20]]], 0, 0, 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-profile-image', [], ['email', ['subexpr', '@mut', [['get', 'email', ['loc', [null, [2, 41], [2, 46]]], 0, 0, 0, 0]], [], [], 0, 0]], ['loc', [null, [2, 16], [2, 48]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('renders and tears down ok with fileStorage:false', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-profile-image', [], ['fileStorage', ['subexpr', '@mut', [['get', 'fileStorage', ['loc', [null, [2, 47], [2, 58]]], 0, 0, 0, 0]], [], [], 0, 0]], ['loc', [null, [2, 16], [2, 60]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-profile-image', [], ['email', ['subexpr', '@mut', [['get', 'email', ['loc', [null, [2, 41], [2, 46]]], 0, 0, 0, 0]], [], [], 0, 0], 'size', 100, 'debounce', 50], ['loc', [null, [2, 16], [2, 69]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('doesn\'t add background url if gravatar image doesn\'t exist', function (done) {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-profile-image', [], ['email', 'test@example.com', 'size', 100, 'debounce', 50], ['loc', [null, [2, 16], [2, 82]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('throttles gravatar loading as email is changed', function (done) {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-profile-image', [], ['email', ['subexpr', '@mut', [['get', 'email', ['loc', [null, [2, 41], [2, 46]]], 0, 0, 0, 0]], [], [], 0, 0], 'size', 100, 'debounce', 300], ['loc', [null, [2, 16], [2, 70]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
...
define('ghost-admin/tests/integration/components/gh-search-input-test', ['exports', 'chai', 'ember-mocha', 'ember-runloop', 'pretender', 'ember-test-helpers/wait'], function (exports, _chai, _emberMocha, _emberRunloop, _pretender, _emberTestHelpersWait) {
        ...
        (0, _emberMocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['content', 'gh-search-input', ['loc', [null, [1, 0], [1, 19]]], 0, 0, 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-subscribers-table', [], ['table', ['subexpr', '@mut', [['get', 'table', ['loc', [null, [1, 29], [1, 34]]], 0, 0, 0, 0]], [], [], 0, 0], 'sortByColumn', ['subexpr', 'action', [['get', 'sortByColumn', ['loc', [null, [1, 56], [1, 68]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 48], [1, 69]]], 0, 0], 'delete', ['subexpr', 'action', [['get', 'delete', ['loc', [null, [1, 85], [1, 91]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 77], [1, 92]]], 0, 0]], ['loc', [null, [1, 0], [1, 94]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('renders', function () {
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-tag-settings-form', [], ['tag', ['subexpr', '@mut', [['get', 'tag', ['loc', [null, [2, 43], [2, 46]]], 0, 0, 0, 0]], [], [], 0, 0], 'setProperty', ['subexpr', 'action', ['setProperty'], [], ['loc', [null, [2, 59], [2, 81]]], 0, 0]], ['loc', [null, [2, 16], [2, 83]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('triggers delete tag modal on delete click', function (done) {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-tag-settings-form', [], ['tag', ['subexpr', '@mut', [['get', 'tag', ['loc', [null, [2, 43], [2, 46]]], 0, 0, 0, 0]], [], [], 0, 0], 'setProperty', ['subexpr', 'action', ['setProperty'], [], ['loc', [null, [2, 59], [2, 81]]], 0, 0], 'showDeleteTagModal', ['subexpr', 'action', ['openModal'], [], ['loc', [null, [2, 101], [2, 121]]], 0, 0]], ['loc', [null, [2, 16], [2, 123]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                ...
                return {
                    ...
                    statements: [['block', 'gh-tags-management-container', [], ['tags', ['subexpr', '@mut', [['get', 'tags', ['loc', [null, [2, 53], [2, 57]]], 0, 0, 0, 0]], [], [], 0, 0], 'selectedTag', ['subexpr', '@mut', [['get', 'selectedTag', ['loc', [null, [2, 70], [2, 81]]], 0, 0, 0, 0]], [], [], 0, 0], 'enteredMobile', 'enteredMobile', 'leftMobile', 'leftMobile'], 0, null, ['loc', [null, [2, 16], [2, 170]]]]],
                    locals: [],
                    templates: [child0]
                };
            })()));
...
define('ghost-admin/tests/integration/components/gh-task-button-test', ['exports', 'chai', 'ember-mocha'], function (exports, _chai, _emberMocha) {
        ...
        (0, _emberMocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-theme-table', [], ['availableThemes', ['subexpr', '@mut', [['get', 'availableThemes', ['loc', [null, [2, 32], [2, 47]]], 0, 0, 0, 0]], [], [], 0, 0], 'activateTheme', ['subexpr', 'action', [['get', 'actionHandler', ['loc', [null, [3, 38], [3, 51]]], 0, 0, 0, 0]], [], ['loc', [null, [3, 30], [3, 52]]], 0, 0], 'downloadTheme', ['subexpr', 'action', [['get', 'actionHandler', ['loc', [null, [4, 38], [4, 51]]], 0, 0, 0, 0]], [], ['loc', [null, [4, 30], [4, 52]]], 0, 0], 'deleteTheme', ['subexpr', 'action', [['get', 'actionHandler', ['loc', [null, [5, 36], [5, 49]]], 0, 0, 0, 0]], [], ['loc', [null, [5, 28], [5, 50]]], 0, 0]], ['loc', [null, [1, 0], [6, 14]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('delete link triggers passed in action', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-theme-table', [], ['availableThemes', ['subexpr', '@mut', [['get', 'availableThemes', ['loc', [null, [2, 32], [2, 47]]], 0, 0, 0, 0]], [], [], 0, 0], 'activateTheme', ['subexpr', 'action', [['get', 'actionHandler', ['loc', [null, [3, 38], [3, 51]]], 0, 0, 0, 0]], [], ['loc', [null, [3, 30], [3, 52]]], 0, 0], 'downloadTheme', ['subexpr', 'action', [['get', 'actionHandler', ['loc', [null, [4, 38], [4, 51]]], 0, 0, 0, 0]], [], ['loc', [null, [4, 30], [4, 52]]], 0, 0], 'deleteTheme', ['subexpr', 'action', [['get', 'deleteAction', ['loc', [null, [5, 36], [5, 48]]], 0, 0, 0, 0]], [], ['loc', [null, [5, 28], [5, 49]]], 0, 0]], ['loc', [null, [1, 0], [6, 14]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('download link triggers passed in action', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-theme-table', [], ['availableThemes', ['subexpr', '@mut', [['get', 'availableThemes', ['loc', [null, [2, 32], [2, 47]]], 0, 0, 0, 0]], [], [], 0, 0], 'activateTheme', ['subexpr', 'action', [['get', 'actionHandler', ['loc', [null, [3, 38], [3, 51]]], 0, 0, 0, 0]], [], ['loc', [null, [3, 30], [3, 52]]], 0, 0], 'downloadTheme', ['subexpr', 'action', [['get', 'downloadAction', ['loc', [null, [4, 38], [4, 52]]], 0, 0, 0, 0]], [], ['loc', [null, [4, 30], [4, 53]]], 0, 0], 'deleteTheme', ['subexpr', 'action', [['get', 'actionHandler', ['loc', [null, [5, 36], [5, 49]]], 0, 0, 0, 0]], [], ['loc', [null, [5, 28], [5, 50]]], 0, 0]], ['loc', [null, [1, 0], [6, 14]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('activate link triggers passed in action', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-theme-table', [], ['availableThemes', ['subexpr', '@mut', [['get', 'availableThemes', ['loc', [null, [2, 32], [2, 47]]], 0, 0, 0, 0]], [], [], 0, 0], 'activateTheme', ['subexpr', 'action', [['get', 'activateAction', ['loc', [null, [3, 38], [3, 52]]], 0, 0, 0, 0]], [], ['loc', [null, [3, 30], [3, 53]]], 0, 0], 'downloadTheme', ['subexpr', 'action', [['get', 'actionHandler', ['loc', [null, [4, 38], [4, 51]]], 0, 0, 0, 0]], [], ['loc', [null, [4, 30], [4, 52]]], 0, 0], 'deleteTheme', ['subexpr', 'action', [['get', 'actionHandler', ['loc', [null, [5, 36], [5, 49]]], 0, 0, 0, 0]], [], ['loc', [null, [5, 28], [5, 50]]], 0, 0]], ['loc', [null, [1, 0], [6, 14]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('renders', function () {
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-timezone-select', [], ['availableTimezones', ['subexpr', '@mut', [['get', 'availableTimezones', ['loc', [null, [2, 35], [2, 53]]], 0, 0, 0, 0]], [], [], 0, 0], 'activeTimezone', ['subexpr', '@mut', [['get', 'activeTimezone', ['loc', [null, [3, 31], [3, 45]]], 0, 0, 0, 0]], [], [], 0, 0]], ['loc', [null, [1, 0], [3, 47]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('triggers update action on change', function (done) {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-timezone-select', [], ['availableTimezones', ['subexpr', '@mut', [['get', 'availableTimezones', ['loc', [null, [2, 35], [2, 53]]], 0, 0, 0, 0]], [], [], 0, 0], 'activeTimezone', ['subexpr', '@mut', [['get', 'activeTimezone', ['loc', [null, [3, 31], [3, 45]]], 0, 0, 0, 0]], [], [], 0, 0], 'update', ['subexpr', 'action', [['get', 'update', ['loc', [null, [4, 31], [4, 37]]], 0, 0, 0, 0]], [], ['loc', [null, [4, 23], [4, 38]]], 0, 0]], ['loc', [null, [1, 0], [4, 40]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('trims value on focusOut', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-trim-focus-input', [['get', 'text', ['loc', [null, [1, 22], [1, 26]]], 0, 0, 0, 0]], ['update', ['subexpr', 'action', [['subexpr', 'mut', [['get', 'text', ['loc', [null, [1, 47], [1, 51]]], 0, 0, 0, 0]], [], ['loc', [null, [1, 42], [1, 52]]], 0, 0]], [], ['loc', [null, [1, 34], [1, 53]]], 0, 0]], ['loc', [null, [1, 0], [1, 55]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('does not have the autofocus attribute if not set to focus', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-trim-focus-input', [['get', 'text', ['loc', [null, [1, 22], [1, 26]]], 0, 0, 0, 0]], ['shouldFocus', false], ['loc', [null, [1, 0], [1, 46]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('has the autofocus attribute if set to focus', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'gh-trim-focus-input', [['get', 'text', ['loc', [null, [1, 22], [1, 26]]], 0, 0, 0, 0]], ['shouldFocus', true], ['loc', [null, [1, 0], [1, 45]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('has no success/error class by default', function () {
            this.render(Ember.HTMLBars.template((function () {
                ...
                return {
                    ...
                    statements: [['block', 'gh-validation-status-container', [], ['class', 'gh-test', 'property', 'name', 'errors', ['subexpr', '@mut', [['get', 'testObject.errors', ['loc', [null, [2, 89], [2, 106]]], 0, 0, 0, 0]], [], [], 0, 0], 'hasValidated', ['subexpr', '@mut', [['get', 'testObject.hasValidated', ['loc', [null, [2, 120], [2, 143]]], 0, 0, 0, 0]], [], [], 0, 0]], 0, null, ['loc', [null, [2, 16], [3, 51]]]]],
                    locals: [],
                    templates: [child0]
                };
            })()));
        ...
        (0, _emberMocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['content', 'modals/delete-subscriber', ['loc', [null, [1, 0], [1, 28]]], 0, 0, 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['content', 'modals/import-subscribers', ['loc', [null, [1, 0], [1, 29]]], 0, 0, 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['content', 'modals/new-subscriber', ['loc', [null, [1, 0], [1, 25]]], 0, 0, 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('renders', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['content', 'modals/upload-theme', ['loc', [null, [1, 0], [1, 23]]], 0, 0, 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
        ...
        (0, _emberMocha.it)('triggers confirm action', function () {
            ...
            this.render(Ember.HTMLBars.template((function () {
                return {
                    ...
                    statements: [['inline', 'modals/transfer-owner', [], ['confirm', ['subexpr', 'action', ['confirm'], [], ['loc', [null, [1, 32], [1, 50]]], 0, 0], 'closeModal', ['subexpr', 'action', ['closeModal'], [], ['loc', [null, [1, 62], [1, 83]]], 0, 0]], ['loc', [null, [1, 0], [1, 85]]], 0, 0]],
                    locals: [],
                    templates: []
                };
            })()));
...
define('ghost-admin/tests/integration/services/ajax-test', ['exports', 'chai', 'ember-mocha', 'pretender', 'ember-ajax/errors', 'ghost-admin/services/ajax', 'ghost-admin/config/environment', 'ember-service', 'rsvp'], function (exports, _chai, _emberMocha, _pretender, _emberAjaxErrors, _ghostAdminServicesAjax, _ghostAdminConfigEnvironment, _emberService, _rsvp) {
    var _slicedToArray = (function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i['return']) _i['return'](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError('Invalid attempt to destructure non-iterable instance'); } }; })();
    ...
    (0, _emberMocha.describeModule)('service:ajax', 'Integration: Service: ajax', {
        ...
        describe('session handling', function () {
            ...
            (0, _emberMocha.it)('can restore an expired session', function (done) {
                var ajax = this.subject();
            ...
            (0, _emberMocha.it)('errors correctly when session restoration fails', function (done) {
                var ajax = this.subject();
...
define('ghost-admin/tests/integration/services/feature-test', ['exports', 'ember-mocha', 'pretender', 'ember-test-helpers/wait', 'ghost-admin/services/feature', 'ember', 'ember-runloop'], function (exports, _emberMocha, _pretender, _emberTestHelpersWait, _ghostAdminServicesFeature, _ember, _emberRunloop) {
...
define('ghost-admin/tests/integration/services/lazy-loader-test', ['exports', 'chai', 'ember-mocha', 'pretender', 'jquery'], function (exports, _chai, _emberMocha, _pretender, _jquery) {
...
define('ghost-admin/tests/mirage/config.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/config/authentication.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/config/configuration.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/config/invites.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/config/posts.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/config/roles.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/config/settings.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/config/slugs.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/config/subscribers.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/config/tags.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/config/themes.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/config/users.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/factories/invite.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/factories/notification.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/factories/post.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/factories/role.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/factories/setting.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - mirage/factories/setting.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
});
define('ghost-admin/tests/mirage/factories/subscriber.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/factories/tag.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/factories/user.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/fixtures/configurations.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/fixtures/roles.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/fixtures/settings.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/fixtures/timezones.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/scenarios/default.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mirage/utils.lint-test', ['exports'], function (exports) {
  'use strict';
...
define('ghost-admin/tests/mixins/active-link-wrapper.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - mixins/active-link-wrapper.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/mixins/settings-menu-controller.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - mixins/settings-menu-controller.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
});
define('ghost-admin/tests/mixins/settings-save.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - mixins/settings-save.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/routes/mobile-index-route.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - routes/mobile-index-route.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/routes/posts/index.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - routes/posts/index.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
});
define('ghost-admin/tests/routes/posts/post.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - routes/posts/post.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/routes/settings/general/uploadtheme.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - routes/settings/general/uploadtheme.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/routes/settings/navigation.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - routes/settings/navigation.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define("ghost-admin/tests/template-deprecations-test", ["exports"], function (exports) {
  "use strict";
});
...
/* jshint expr:true */
define('ghost-admin/tests/unit/components/gh-content-preview-content-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - unit/components/gh-content-preview-content-test.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/unit/controllers/post-settings-menu-test', ['exports', 'ember-runloop', 'rsvp', 'ember-object', 'ember-mocha'], function (exports, _emberRunloop, _rsvp, _emberObject, _emberMocha) {
...
/* eslint-disable camelcase */
define('ghost-admin/tests/unit/controllers/post-settings-menu-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - unit/controllers/post-settings-menu-test.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
/* jshint expr:true */
define('ghost-admin/tests/unit/controllers/settings/navigation-test.lint-test', ['exports'], function (exports) {
  'use strict';

  describe('ESLint - unit/controllers/settings/navigation-test.js', function () {
    it('should pass ESLint', function () {
      // precompiled test passed
    });
  });
...
define('ghost-admin/tests/unit/models/invite-test', ['exports', 'chai', 'ember-mocha', 'ember-runloop', 'pretender'], function (exports, _chai, _emberMocha, _emberRunloop, _pretender) {
    var _slicedToArray = (function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i['return']) _i['return'](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError('Invalid attempt to destructure non-iterable instance'); } }; })();

    (0, _emberMocha.describeModel)('invite', 'Unit: Model: invite', {
        ...
        describe('with network', function () {
            ...
            (0, _emberMocha.it)('resend hits correct endpoint', function () {
                var _this = this;
...
define('ghost-admin/tests/unit/serializers/notification-test', ['exports', 'chai', 'ember-mocha', 'pretender'], function (exports, _chai, _emberMocha, _pretender) {
...
define('ghost-admin/tests/unit/services/config-test', ['exports', 'chai', 'ember-mocha'], function (exports, _chai, _emberMocha) {
...
define('ghost-admin/tests/unit/transforms/facebook-url-user-test', ['exports', 'chai', 'ember-mocha'], function (exports, _chai, _emberMocha) {
...
define('ghost-admin/tests/unit/transforms/json-string-test', ['exports', 'chai', 'ember-mocha'], function (exports, _chai, _emberMocha) {

    (0, _emberMocha.describeModule)('transform:json-string', 'Unit: Transform: json-string', {}, function () {
        (0, _emberMocha.it)('exists', function () {
            var transform = this.subject();
            (0, _chai.expect)(transform).to.be.ok;
        });

        (0, _emberMocha.it)('serialises an Object to a JSON String', function () {
            var transform = this.subject();
            var obj = { one: 'one', two: 'two' };
            (0, _chai.expect)(transform.serialize(obj)).to.equal(JSON.stringify(obj));
        });

        (0, _emberMocha.it)('deserialises a JSON String to an Object', function () {
            var transform = this.subject();
            var obj = { one: 'one', two: 'two' };
...
define('ghost-admin/tests/unit/transforms/twitter-url-user-test', ['exports', 'chai', 'ember-mocha'], function (exports, _chai, _emberMocha) {
